...
export default function WelcomeBanner({ icon, title, subtitle }: WelcomeBannerProps) {
  return (
    <div className="relative rounded-2xl border border-white/90 bg-white/70 p-7 shadow-[0_12px_32px_rgba(0,0,0,0.04)] backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.04] dark:shadow-[0_12px_32px_rgba(0,0,0,0.3)]">
